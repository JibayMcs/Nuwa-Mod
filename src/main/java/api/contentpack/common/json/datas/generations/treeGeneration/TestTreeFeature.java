package api.contentpack.common.json.datas.generations.treeGeneration;
...
public class TestTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState LOG = Blocks.SAND.getDefaultState();
    private static final BlockState LEAF = Blocks.STONE.getDefaultState();

    private final boolean useExtraRandomHeight;

    public TestTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, boolean extraRandomHeightIn) {
