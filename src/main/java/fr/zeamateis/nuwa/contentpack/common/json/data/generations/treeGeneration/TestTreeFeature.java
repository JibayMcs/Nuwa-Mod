package fr.zeamateis.nuwa.contentpack.common.json.data.generations.treeGeneration;
...
public class TestTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("mff:mff_leaves")).getDefaultState();

    public TestTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49895_1_, boolean p_i49895_2_) {
