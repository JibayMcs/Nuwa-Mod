...
/**
 * Json parsed {@link FenceBlock}
 *
 * @author ZeAmateis
 */
public class JsonFenceBlock extends FenceBlock implements IJsonBlock {

    private VoxelShape shape, collisionShape;
    private ItemGroup itemGroup;
    private BlockEventObject eventProperties;

    public JsonFenceBlock(Properties properties, @Nonnull ResourceLocation registryNameIn) {
        super(properties);
